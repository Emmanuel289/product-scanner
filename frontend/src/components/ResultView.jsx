  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ color: "#666", fontFamily: "'DM Sans', sans-serif", fontSize: 12, letterSpacing: 2, textTransform: "uppercase", marginBottom: 4 }}>
          {activeData.brand}
        </div>
        <div style={{ color: "#fff", fontFamily: "'DM Serif Display', serif", fontSize: 26, lineHeight: 1.2, marginBottom: 12 }}>
      ...
      {isPersonalized && fitScore !== null && (
        <div style={{ background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 16, padding: 20, marginBottom: 16 }}>
          ...
          <div style={{ textAlign: "center", color: "#aaa", fontFamily: "'DM Sans', sans-serif", fontSize: 13 }}>
            Fit score for <strong style={{ color: "#fff" }}>{skinType}</strong> skin
            <div style={{ fontSize: 11, color: "#555", marginTop: 4 }}>
              Score reflects skin type alignment, targeted concerns, and risk factors
            </div>
          </div>
        </div>
      )}
      ...
      <div style={{ background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 16, padding: 20, marginBottom: 16 }}>
        ...
        {s.skin_types?.length > 0 && (
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {s.skin_types.map((t) => <PillTag key={t} text={t} variant="good" />)}
            </div>
          </div>
        )}
        ...
        {s.avoid_for?.length > 0 && (
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {s.avoid_for.map((t) => <PillTag key={t} text={t} variant="warn" />)}
            </div>
          </div>
        )}
